(()=>{
  ...
  document.title='Letture contatori V8.2 TEST';const h=document.querySelector('h1 small');if(h)h.textContent='V8.2 TEST';const foot=q('.foot');if(foot)foot.textContent='V8.2 TEST · profili display derivati dal dataset · nessun merge in main.';applyProfile();
})();
