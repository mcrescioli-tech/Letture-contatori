(()=>{
  ...
  document.title='Letture contatori V7 TEST';const h=document.querySelector('h1 small');if(h)h.textContent='V7 TEST';const foot=q('.foot');if(foot)foot.textContent='V7 TEST · profili display derivati dal dataset · nessun merge in main.';applyProfile();
})();
